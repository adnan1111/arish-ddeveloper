...
function mytheme_enqueue_scripts(){ 
	...
	wp_register_script( 'jcarousel_responsive', plugins_url( '/js/jcarousel.responsive.js', __FILE__ ), array( 'jquery' ) );			wp_register_script( 'jcarousel_easing', plugins_url( '/js/jcarousel.easing.js', __FILE__ ), array( 'jquery' ) );
  ...
  if (!is_admin()): 
	...
	wp_enqueue_script('jcarousel_responsive');			wp_enqueue_script('jcarousel_easing');
