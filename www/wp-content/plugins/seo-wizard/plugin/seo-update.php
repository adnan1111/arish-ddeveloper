 ...
 * @since 0.1
 */
define('SU_MODULE_ENABLED',  __('Enabled', 'seo-wizard'));
define('SU_MODULE_SILENCED', __('Silenced', 'seo-wizard'));
define('SU_MODULE_HIDDEN',  __('Hidden', 'seo-wizard'));
define('SU_MODULE_DISABLED', __('Disabled', 'seo-wizard'));
...
/*	function add_network_admin_menus() {
	...
	*/
	...
	function sdf_dashboard_widget_function() {
	    		$html1 = '<center><a href="http://www.seowizard.org/" target="_blank"><img src="../wp-content/plugins/seo-wizard/img/logo/wp_seo_wizard_logo.png" height="100"/></a> </center>';
		echo $html1;
     $rss = fetch_feed('http://seowizard.org/feed');
        ...
        if( !is_wp_error($rss)) {
            ...
            else
            {
                ...
                foreach ($rss_items as $item) {
                    $html .= '<li><center><a href="'.esc_url($item ->get_permalink()).'" title = "Posted '.$item -> get_date().'" target="_blank" style = "margin-right:20px;">'.esc_html( $item ->get_title()).'</a>   '.$item ->get_date("j F Y").' </center></li>';
                }
            }
		...
		$html2 = '<center><a href="http://www.seowizard.org/monthly-seo-services/" target="_blank"><strong><font color="green"><font size="4">Improve your SEO with our monthly services!</font></font></strong></a> </center>';
		echo $html2;
	} 
}
?>